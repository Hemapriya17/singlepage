      ...
      >
        <div className="flex items-center justify-between">
          <h3 className="price mb-2 text-3xl font-bold text-black dark:text-white">
            ...
            <span className="time text-body-color dark:text-white">/{duration}</span>
          </h3>
          <h4 className="mb-2 text-xl font-bold text-dark dark:text-white">
            {packageName}
          </h4>
        </div>
        <p className="mb-7 text-base text-body-colo dark:text-whiter">{subtitle}</p>
        ...
        <div className="absolute bottom-0 right-0 z-[-1]">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#F1C232" stopOpacity="0.62" />
                <stop offset="1" stopColor="#F1C232" stopOpacity="0" />
              </linearGradient>
              <linearGradient
