const NewsLatterBox = () => {
  return (
    ...
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base font-medium leading-relaxed dark:text-white text-body-color dark:border-white dark:border-opacity-25 justify-center">
      Welcome to our subscription service, by subscribing to our updates, you will gain exclusive access to timely and relevant information delivered straight to your inbox.
      </p>
      <form>
        <input
          type="text"
